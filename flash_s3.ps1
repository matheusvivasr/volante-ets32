# flash_s3.ps1 – Grava o firmware na ESP32-S3
# Uso: .\flash_s3.ps1 -Port COM3
param([string]$Port = "COM3")

$TOOLCHAIN  = "C:\Users\Vivas\.espressif\tools\xtensa-esp-elf\esp-14.2.0_20241119\xtensa-esp-elf\bin"
